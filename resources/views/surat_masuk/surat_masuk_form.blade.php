...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cetak Surat Masuk</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item active">Cetak Surat Masuk</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h3 class="card-title">Cetak Data Surat Masuk Per-tanggal</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <a href="" onclick="this.href='/laporan/surat_masuk/cetak_data_pertanggal/'+document.getElementById('tgl_awal').value +
                                '/' + document.getElementById('tgl_akhir').value" target="_blank" class="btn btn-primary">
                                    <i class="fas fa-print"></i> Cetak Data Surat Masuk</a>
                            </div>
                        </div>
                    </div>
                </div>
